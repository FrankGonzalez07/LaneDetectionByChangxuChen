...
class LaneLinesDetection:
    def __init__(self):
        ...
        self.dir = []
        self.left_curve_img = mpimg.imread('left_turn.png', 0)
        self.right_curve_img = mpimg.imread('right_turn.png', 0)
        self.keep_straight_img = mpimg.imread('straight.png', 0)
    ...
    def plot(self, out_img):
        ...
        msg = "前方请保持执行！"
        curvature_msg = "弯道曲率为 {:.0f} 米".format(min(lR, rR))
        if direction == 'L':
